...
const Layout = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-x-hidden">
      {/* Both backgrounds are always rendered, but opacity is controlled by theme */}
      ...
      >
        <div 
          className="absolute bottom-auto left-auto right-0 top-0 h-[500px] w-[500px] -translate-x-[30%] translate-y-[20%] rounded-full bg-[rgba(173,109,244,0.5)] opacity-50 blur-[80px] transition-all duration-500 ease-in-out"
        ></div>
      </div>
